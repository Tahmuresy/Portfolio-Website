...
const REG = {
  ...
  tabriz: { title: "Tabriz Audio Arts Center", icon: "Folder", comp: "TabrizAudio", w: 900, h: 640 },
...
{ key: "tabriz", kind: "win", label: "Tabriz Audio Arts Center", anchor: "tl", ax: 128, ay: 622, preview: "assets/img/tabriz/render-1.jpg", caption: "Tabriz Audio Arts Center", year: "2017" },
...
// ── TOP-RIGHT (4th column) · extra software (display-only) ────────
{ key: "vscode", kind: "app", label: "Visual Studio Code", img: "assets/img/app-vscode.png", noClick: true, anchor: "tr", ax: 396, ay: 22 },
{ key: "vray", kind: "app", label: "V-Ray", img: "assets/img/app-vray.jpg", brand: true, noClick: true, anchor: "tr", ax: 396, ay: 118 },
{ key: "karamba", kind: "app", label: "Karamba3D", img: "assets/img/app-karamba.png", noClick: true, anchor: "tr", ax: 396, ay: 214 },
...
{ key: "scholar", kind: "link", label: "Google Scholar", img: "assets/img/ic-scholar.png", brand: true, url: "https://scholar.google.com/citations?user=oIuTKCkAAAAJ&hl=en", anchor: "br", ax: 584, ay: 122 },
{ key: "researchgate", kind: "link", label: "ResearchGate", img: "assets/img/ic-researchgate.png", brand: true, url: "https://www.researchgate.net/profile/Tahmures-Ghiyasi?ev=hdr_xprf", anchor: "br", ax: 680, ay: 122 }];
    ...
    <div className="startmenu" onPointerDown={(e) => e.stopPropagation()}>
      ...
      <div className="startmenu__body">
        <div className="startmenu__col startmenu__col--left">
          ...
          <div className="sm-item" onClick={() => onPick("tabriz")}>
            <span className="sm-item__ico">{II.Folder()}</span><div><b>Tabriz Audio Arts Center</b><small>Tabriz Islamic Arts Univ. · 2017</small></div>
          </div>
        </div>
...
function Desktop({ tweaks, onLogoff, avatar, wallpaper }) {
  ...
  const openItem = uCB((it) => {setPreview(null);if (it.noClick) return;if (it.kind === "link") {window.open(it.url, "_blank", "noopener");} else if (it.kind === "app") launchApp(it.key);else api.open(it.key);}, [api.open, launchApp]);
